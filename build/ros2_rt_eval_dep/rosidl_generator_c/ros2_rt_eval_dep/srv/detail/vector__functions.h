...
#ifndef ROS2_RT_EVAL_DEP__SRV__DETAIL__VECTOR__FUNCTIONS_H_
#define ROS2_RT_EVAL_DEP__SRV__DETAIL__VECTOR__FUNCTIONS_H_
...
/// Create srv/Vector message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros2_rt_eval_dep__srv__Vector_Request__init().
...
/// Destroy srv/Vector message.
/**
 * It calls
 * ros2_rt_eval_dep__srv__Vector_Request__fini()
...
/// Check for srv/Vector message equality.
/**
...
/// Initialize array of srv/Vector messages.
/**
...
/// Finalize array of srv/Vector messages.
/**
 * It calls
 * ros2_rt_eval_dep__srv__Vector_Request__fini()
...
/// Create array of srv/Vector messages.
/**
 * It allocates the memory for the array and calls
 * ros2_rt_eval_dep__srv__Vector_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Vector messages.
/**
 * It calls
 * ros2_rt_eval_dep__srv__Vector_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Vector message array equality.
/**
...
/// Copy an array of srv/Vector messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros2_rt_eval_dep__srv__Vector_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_rt_eval_dep
...
/**
 * It calls
 * ros2_rt_eval_dep__srv__Vector_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_rt_eval_dep
...
/**
 * It allocates the memory for the array and calls
 * ros2_rt_eval_dep__srv__Vector_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_rt_eval_dep
...
/**
 * It calls
 * ros2_rt_eval_dep__srv__Vector_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROS2_RT_EVAL_DEP__SRV__DETAIL__VECTOR__FUNCTIONS_H_
